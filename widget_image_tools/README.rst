...
* 2. The widget passes options directly through to image, which supports the 
  ...
  .. image:: https://raw.githubusercontent.com/shurshilov/web/9.0/widget_image_tools/static/description/Menu.png
     :alt: WIE menu
     :class: img-thumbnail
     :height: 360

  .. image:: https://raw.githubusercontent.com/shurshilov/web/9.0/widget_image_tools/static/description/Edit.png
     :alt: WIE edit
     :class: img-thumbnail col-xs-offset-1
     :height: 360

  .. image:: https://raw.githubusercontent.com/shurshilov/web/9.0/widget_image_tools/static/description/Zoom.png
     :alt: WIE zoom
     :class: img-thumbnail col-xs-offset-1
     :height: 360

  .. image:: https://raw.githubusercontent.com/shurshilov/web/9.0/widget_image_tools/static/description/Preview.png
     :alt: WIE preview
     :class: img-thumbnail col-xs-offset-1
     :height: 360

  .. image:: https://raw.githubusercontent.com/shurshilov/web/9.0/widget_image_tools/static/description/Download_origin.png
